...
const Navbar = () => {
    ...
    const navItems = [
        { id: 1, text: 'Home', href: 'https://acmdevday.com/' },
        { id: 2, text: 'About Us', href: 'https://acmdevday.com/about' },
        { id: 3, text: 'Register', href: 'https://acmdevday.com/register' },
        {id: 4, text: 'ChatBot', href: 'https://chatbot.acmdevday.com'},
